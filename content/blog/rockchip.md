...
Context: Over the course of 2 years at [FUTO](https://futo.org/) I worked with Rockchip's documentation and open-source code to develop a [minimal bootloader](https://github.com/petabyt/rk)
for the RK3399 and RK3588. This is my overall conclusion of Rockchip as a company, and the products and services they provide.

## Documentation
- Context: Rockchip is commonly referred to as an 'open-source SoC company'
- In both the RK3399 and RK3588 TRMs[^10], exactly **67%** of subsystems[^1] on the chip are documented[^2]
...
- *"I was told Rockchip no longer considers RK3588 to be an "open source" chip. In practice, that means Rockchip no longer contributes RK3588 code to open-source projects and they also decided not to sell RK3588 directly to SBC vendors."*[^8]
	- Good news: Rockchip is still consistently contributing RK3588 code to the kernel
	- Rockchip has refused to make *any* documentation at all available for the RK3588 [^9]
	- My opinion: Rockchip is insane if they ever considered RK3588 'open source' in the first place
