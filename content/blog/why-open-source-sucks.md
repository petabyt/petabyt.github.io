...
for over 6 years, I think it's flawed.
...
There's also a little bit of culture involved. For games, people are always willing to pay up, and customers set very high expectations. Even for free games, players set a high bar for quality. Free and open-source games that don't meet that bar are criticized harshly.

Making entertaining and user friendly games is an extremely difficult and tedious task, and sadly, a lot of people do it for money.
...
Most successful open source funding models are based on voluntary user and corporate donations. This causes a bias in where money goes, since open source is a concept that only appeals mostly to nerds (and not gamers).
...
Can somebody pick it back up and resurrect it? Yes. But that person will likely experience the same pain, and abandon it.
...
This isn't an attack on open source. I've contributed to open source for years, and will continue to do so.
I've simply realized it's not the revolutionary idea I've been told it was because, because I've been dissapointed too often.
